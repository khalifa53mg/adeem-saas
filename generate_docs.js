  ...
  return [
    ...
    },
    {
      ...
      stepsEn: [
        ...
        'Enter the payment amount and select the payment method. The available methods are configured under <strong>Settings → Payment Methods</strong>.',
      ...
      stepsAr: [
        ...
        'أدخل مبلغ الدفعة واختر طريقة الدفع. تُضبط الطرق المتاحة من <strong>الإعدادات ← طرق الدفع</strong>.',
